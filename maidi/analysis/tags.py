...
class TagsProvider:
    ...
    def get_pitches(self, track_bar, chord, score):
        pitches = track_bar["pitch"]
        return list(pitches)

    def get_start_end_notes(self, track_bar, chord, score):
    ...
    def tag_score(self, score):
        ...
        for idx_track, track_key in enumerate(score.track_keys):
            ...
            for idx_bar in range(score.nb_bars):
                ...
                chord = score.chords[idx_bar]
                for provider in self.tags_providers:
                    bar_tags += provider.get_tags(track_bar, chord, score)
