...
from midi_parser.control_features.special_notes import get_special_notes_tags, get_token_names
...
def test_get_special_notes_tags_case_3(mock_parse_pitch):
    ...
    assert result == [('s', 1), ('s', 3)]  # Top 3 should be returned, but s0 in top 3 so not returned
