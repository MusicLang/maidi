import pytest
from midi_parser.control_features.density import get_density, get_density_value, get_token_names
...
def test_get_density():
    ...
    notes = [(0, 0.5), (0.1, 0.6), (0.2, 0.7), (0.3, 0.8), (0.4, 0.9), (0.5, 1), (0.6, 1.1), (0.7, 1.2)]
    assert get_density(notes, 2) == 'MEDIUM'  # density = 8/2 = 4

    # Test case with notes leading to 'VERY_HIGH' density
    notes = [(0, 0.25), (0.1, 0.35), (0.2, 0.45), (0.3, 0.55), (0.4, 0.65), (0.5, 0.75), (0.6, 0.85), (0.7, 0.95),
             (0.8, 1.05), (0.9, 1.15)]
...
def test_get_token_names():
    expected_token_names = [
        'CONTROL_DENSITY__LOWEST', 'CONTROL_DENSITY__LOWER', 'CONTROL_DENSITY__LOW',
        'CONTROL_DENSITY__MEDIUM_LOW', 'CONTROL_DENSITY__MEDIUM', 'CONTROL_DENSITY__HIGH',
